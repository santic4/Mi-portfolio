const projects = [
  {
    ...
    description:
      "Una operación compleja llevada a una sola plataforma: sitio público, paneles por rol, procesos internos y una infraestructura lista para crecer. ebeneficios.com.ar",
        ...
        <div className="hero-grid shell">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              ...
              <a className="button button-quiet" href="mailto:santisv4@gmail.com">Hablemos <span aria-hidden="true">↗</span></a>
            </div>
